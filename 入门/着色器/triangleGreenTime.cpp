...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		int vertexColorLocation = glGetUniformLocation(shaderProgram, "ourColor");//找到着色器里的Uniform位置
		glUniform4f(vertexColorLocation, 0.0f, greenValue, 0.0, 1.0f);//给着色器的uniform传值
